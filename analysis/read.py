...
class FiTQunOutput:
    ...
    def __init__(self, file_path):
        ...
        self.n_multiring_fits = self.chain['']
        self.multiring_fit_id = self.chain['']
        self.multiring_n_rings = self.chain['']
        self.multiring_flag = self.chain['']
        self.multiring_pid = self.chain['']
        self.multiring_momentum = self.chain['']
        self.multiring_position = self.chain['']
        self.multiring_direction = self.chain['']
        self.multiring_time = self.chain['']
        self.multiring_total_charge = self.chain['']
        self.multiring_nll = self.chain['']
        self.multiring_conversion_length = self.chain['']
        self.multiring_energy_loss = self.chain['']
