...
class PointNetMultiPMTDataset(H5Dataset):
    ...
    def  __getitem__(self, item):
        ...
        hit_mpmts = self.hit_pmts // pmts_per_mpmt
        hit_pmt_in_modules = self.hit_pmts % pmts_per_mpmt
        ...
        data[charge_channels, unique_hit_mpmts] = self.hit_charges
        data[time_channels, unique_hit_mpmts] = self.hit_times
